export default [{
    ...
    mixin: (Ember, args) => ({
        ...
        // e.g
        // https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/default/v1/profile-icons/4599.jpg
        ...
        didRender() {
            if (this.get('spoofingEnabled')) {
                ...
                if (this.get('customSummonerIconUrl') !== '') {
                    ...
                    this.set(
                        'profileIconPath',
                        `/lol-game-data/assets/v1/profile-icons/${this.get('summonerIconId')}.jpg`)
                }
            }
        }
    })
